...
const DEFAULT_EXAM_SCOPES: ExamScopeItem[] = [
  ...
  // 2학년 과목
  {
    ...
    scope: '(9월 22일 월요일 09:00 교무실 일괄 공지 예정)',
    textbookPages: '공지 대기 중',
    supplementary: '학습 프린트 1~12차시 예정',
    notice: '월요일 전체 조회 및 게시판 공지 후 실시간 업데이트됩니다.',
  ...
  },
  {
    ...
    scope: '(9월 22일 월요일 09:00 교무실 일괄 공지 예정)',
    textbookPages: '공지 대기 중',
    supplementary: '탐구 실험 학습지 포함 여부 협의 중',
